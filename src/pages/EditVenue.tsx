...
const formSchema = z.object({
  ...
  animal_assisted_therapy: z.string().optional(),
  ...
  mindfulness_based_cognitive_therapy: z.string().optional(),
  ...
  animal_assisted_therapy_coaching: z.string().optional(),
  ...
  mindfulness_based_cognitive_therapy_coaching: z.string().optional(),
  ...
  animal_assisted_therapy_consulting: z.string().optional(),
